<?php echo $this->Html->script('basic-profile',false); ?>
		...
		<div class="preguntas">
			...
			<div style="overflow: hidden;">
				<div style="float: left; overflow: hidden;">
					<h2 style="background: whitesmoke; margin-top: 0.5em;">Buscar egresado:</h2>
				</div>
			</div>

		<?php echo $this->Form->create('BasicProfile',  array('url'=> "/find")); ?>
			...
			<div id="logs">
				<?php if($log){ ?>
					...
					<div id="logs-basic-profile-0" >
						<div id="log-basic-profile-<?php echo $log['BasicProfile']['id']; ?>" style="overflow: hidden; color: black; background: white; padding: 7px 14px; margin-bottom: 18px; border-radius: 3px;  border: 1px solid;">
							
							<div style="overflow: hidden;">
								<div style="overflow: hidden; float: left;"> 
									<span  id="log-content-basic-profile-<?php echo $log['BasicProfile']['id'] ?>" >
										<b>Cedula:</b> <?php echo $log['BasicProfile']['document']; ?> <br>
										<b>Nombre:</b> <?php echo $log['BasicProfile']['first_name']; ?>. 
										<b>Seg. Nombre: </b> <?php echo $log['BasicProfile']['second_name']; ?>. <br>
										<b>Apellido:</b> <?php echo $log['BasicProfile']['first_last_name']; ?>. 
										<b>Seg. Apellido:</b> <?php echo $log['BasicProfile']['second_last_name']; ?>. <br>
									</span>
								</div>
								<div style="float: right;">
									<a class="edit-this-basic-profile start-lightbox-b" id="edit-this-basic-profile-<?php echo $log['BasicProfile']['id'] ?>" href="#">Editar <img src="/img/edit.png" alt="CakePHP" style="width: 14px; cursor: pointer;"></a>  
									<a class="delete-this-basic-profile" id="delete-this-basic-profile-<?php echo $log['BasicProfile']['id'] ?>" href="#">Borrar <img src="/img/deleted.png" alt="CakePHP" style="width: 14px; cursor: pointer;"></a>
								</div>
							</div>
							...
							<div  style="overflow: hidden;" >
								...
								<div style="overflow: hidden;">
									<div style="overflow: hidden; float: left;">
										<div style="padding-top: 4px;">
											<a class="start-lightbox-c add-this-academic-profile" id="add-this-academic-profile-<?php echo $log['BasicProfile']['id'] ?>" href="#">Añadir un logro academico</a>
										</div>
								...
								<div id="logs-academic-profile-<?php echo $log['BasicProfile']['id'] ?>">				
									<?php if($log['AcademicProfile']){ ?>
										<?php foreach($log['AcademicProfile'] as $v){ ?>
											<div id="log-academic-profile-<?php echo $v['id'] ?>" style="overflow: hidden;border: 1px solid;padding: 10px;border-radius: 3px 3px; margin-top: 7px;">
												<div id="log-content-academic-profile-<?php echo $v['id'] ?>" style="overflow: hidden; float: left;">
													<li>Graduado de: <?php echo $v['Graduate']['GraduateType']['name']; ?> en <?php echo $v['Graduate']['name']; ?></li>
													<li>Promoción: <?php echo $v['Promotion']['name']; ?></li>	
													<li>Specialidad: <?php  echo $v['Specialty']['name']; ?></li>	
													<li>Indice Academico: <?php echo $v['academic_index'] ?></li>
												</div>
												<div style="float: right;">
													<a class="edit-this-academic-profile start-lightbox-d" id="edit-this-academic-profile-<?php echo $v['id'] ?>" href="#">Editar <img src="/img/edit.png" alt="CakePHP" style="width: 14px; cursor: pointer;"></a>  
													<a class="delete-this-academic-profile" id="delete-this-academic-profile-<?php echo $v['id'] ?>" href="#">Borrar <img src="/img/deleted.png" alt="CakePHP" style="width: 14px; cursor: pointer;"></a>
												</div>
											</div>
										<?php } ?>
									<?php } ?>
