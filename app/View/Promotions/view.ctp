		...
		<div class="preguntas">
			...
			<div style="overflow: hidden;">
				<div style="float: left; overflow: hidden;">
					<h2 style="background: whitesmoke; margin-top: 0.5em;">Promoción:</h2>
				</div>
				<div style="float: right; overflow: hidden;">
					<div style="margin-top: 16px; overflow: hidden;">
						
						<?php if(isset($logs)){ ?>
							<!-- <a href="#" class="add-this-basic-profile start-lightbox-a" id="add-this-basic-profile-0" >Agrega un egresado a esta promoción.</a> -->
						<?php } ?>
			...
			<div style="overflow: hidden; padding-left: 10px;">
				<?php  echo '<h3 style="margin-top: 0px;">'.$promotion['Promotion']['name'].' - '.$promotion['Promotion']['date'].'</h3>'; ?>
			</div>
